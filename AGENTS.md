...
| MCP production containment: the production Supabase MCP entry carries read_only=true; every Supabase MCP project_ref is one of the two ledger refs | CF-160, PR-40 | `scripts/check_mcp_containment.py` (`.github/workflows/docs-integrity.yml`) |
